...
import { Home, Package, Users, Truck, Users as UsersIcon, LogOut, Menu, User } from 'lucide-react';
        ...
        <nav>
          <ul className="space-y-2 mt-5">
            {[
              ...
              { name: 'User Management ', icon: Truck, path: '/admindashboard/usermanagement' },
              // { name: 'Product Mnagement', icon: Users, path: '/admindashboard/productmanagement' },
              // { name: 'Order Management', icon: User, path: '/admindashboard/ordermanagement' },
              { name: 'Profile', icon: User, path: '/admindashboard/profile' },
